      ...
      <div className="overflow-hidden">
        ...
        <section className="px-[4vw] py-16 md:py-24 max-w-[1500px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-[55%_45%] items-start">
            ...
            <div className="relative mt-14 md:mt-0 h-[500px] md:h-[650px] w-full group overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
              <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
              ...
              >
                ...
                <Img
                  height="620px"
                  bg="#1a1814"
                  src="/img/Linea%20Fina/linea_fina_47.webp"
                  alt={t("about.imgAlt2")}
        ...
        <section className="px-[4vw] py-20 md:py-32 text-center" style={{ backgroundColor: "#141210" }}>
          <motion.div
            initial={{ opacity: 0, y: 18 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.65 }}
            className="max-w-[1500px] mx-auto flex flex-col items-center space-y-10"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8 w-full max-w-[480px]">
              <Link
                to="/tattoo"
